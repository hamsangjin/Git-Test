...
@Getter
public class SignUpRspDto extends ResponseDto {
    private SignUpRspDto() {
        super();
    }

    public static ResponseEntity<SignUpRspDto> success() {
        SignUpRspDto responseBody = new SignUpRspDto();
